...
def mandelFragment(Fx,Fy,w,h):
    x0 = mandelXscale[0] + (mandelXscale[1] - mandelXscale[0]) * Fx/w  # lerp(a,b,t) = a + (b - a) * t
    y0 = mandelYscale[0] + (mandelYscale[1] - mandelYscale[0]) * Fy/h
    ...
    if iteration == max_iteration:
        ...
        col1 = colorRGB(0,1,1)
        return colorLerp(col1, col2, (iteration%40)/40)
	

for Py in range(HEIGHT):
        for Px in range(WIDTH):
            putPixel(Px, Py, mandelFragment(Px,Py,WIDTH,HEIGHT))
